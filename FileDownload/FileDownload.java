...
public class FileDownload {
	...
	public static void main(String[] args) throws Exception {
        ...
        fd.setFileUrl("http://speedtest.ftp.otenet.gr/files/test10Mb.db");
        fd.setDownloadRange(0, 10000);
        fd.setFileLocation("/home/srinidhi/Myworks/java_tutorial/FileDownload/test");
        fd.startDownload();
